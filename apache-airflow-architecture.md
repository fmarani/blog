+++
date = "2017-05-03T10:17:15+01:00"
...
Airflow offers a web UI and most operations are done from there. One of the most helpful web views is the tree view. It is a matrix where rows represent tasks and columns represent the time intervals. If your workflow is made up of 3 tasks and runs daily, columns will be days and the 3 rows will be the 3 tasks. Each cell will then represent the task run status.
...
Another view that is interesting to look at is task duration. It's about how long each tasks take from start to end. Useful if you want to make sure they run within a certain amount of time. Similar view is the Gantt chart.
...
Airflow is made up of two components: webserver and scheduler. 
...
- scheduler: executors
- schedulers: dagruns and polling
